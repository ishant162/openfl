...
train.data = mnist_train.data[0:10000:n_collaborators]
train.targets = mnist_train.targets[0:10000:n_collaborators]
test.data = mnist_test.data[0:1000:n_collaborators]
test.targets = mnist_test.targets[0:1000:n_collaborators]
